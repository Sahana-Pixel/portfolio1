...
export function SkillCard({ name, icon: Icon, color, url }: SkillCardProps) {
  return (
    <a 
      ...
      className="group relative flex flex-col items-center p-2 bg-white dark:bg-black border border-gray-200 dark:border-gray-700 rounded-xl shadow-md transition-transform duration-300 transform hover:-translate-y-2 hover:shadow-2xl 
